...
export const CollateralInput = ({ collateralLogo, collateralToken, amountIn, setCollateralLogo, logoChange, setCollateralToken, setAmountIn, getCollateralAddress }) => {
				...
				<Flex>
					<Menu>
						<MenuButton as={Button} w="200px" rightIcon={<ChevronDownIcon />} colorScheme="blue" bgGradient="linear(to-r, #9D8DF1, #B8CDF8, #1CFEBA)" p={2}>
							<Flex>
								<Image src={collateralLogo} boxSize={6} mr={3} />
